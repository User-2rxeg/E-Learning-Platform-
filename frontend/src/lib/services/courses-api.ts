// src/lib/service/courses-api.ts - FIXED VERSION
...
// progress-tracking tracking interfaces
...
// FIXED: Handle different response structures
    ...
    // NEW: progress-tracking tracking methods that actually save to backend
    ...
    //                     );
    //                     console.log(`Upload progress-tracking: ${percentCompleted}%`);
    //                 },
