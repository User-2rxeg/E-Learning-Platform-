...
//     );
//     const hasAccessToken = request.cookies.has(APP_CONFIG.COOKIES.ACCESS_TOKEN);
// // Redirect unauthenticated users
//     if (!hasAccessToken && !isPublicRoute && !pathname.startsWith('/api')) {
//         const loginUrl = new URL(APP_CONFIG.ROUTES.AUTH.LOGIN, request.url);
//         loginUrl.searchParams.set('from', pathname);
//         return NextResponse.redirect(loginUrl);
//     }
